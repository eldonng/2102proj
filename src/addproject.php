        ...
        <table class='rg-table' summary='CrowdFund'>
          ...
          <tbody>
            ...
            <tr style="display: none;" id="projectForm">
              <td><input value="test" id="category-value" class="form-field" type="text" name="category" </td> </tr>
                  <tr id="projectForm">
              <td> Title: </td>
              <td><input class="form-field" type="text" name="title" </td> </tr> <tr id="projectForm">
              <td> Start Date: </td>
              <td><input class="form-field" type="date" name="startdate" </td> </tr> <tr id="projectForm">
              <td> End Date: </td>
              <td><input class="form-field" type="date" name="enddate" </td> </tr> <tr id="projectForm">
              <td> Target Amount: </td>
              <td><input class="form-field" type="text" name="targetamount" </td> </tr> <tr id="projectForm">
              <td> Description: </td>
